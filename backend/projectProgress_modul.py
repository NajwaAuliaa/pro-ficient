...
def refresh_user_token(user_id: str) -> str:
    ...
    try:
        ...
        headers = {
            ...
            'Origin': 'http://internalassistant-e6acf6beh9acc8en.southeastasia-01.azurewebsites.net'  # Add origin for SPA
        }
...
def make_authenticated_request(url: str, user_id: str, method: str = "GET", data: dict = None):
    ...
    headers = {
        ...
        "Origin": "http://internalassistant-e6acf6beh9acc8en.southeastasia-01.azurewebsites.net"  # Add origin for SPA requests
    }
