...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://internalassistant-e6acf6beh9acc8en.southeastasia-01.azurewebsites.net",
                ...
                <body>
                    <script>
                        if (window.opener) {{
                            ...
                            window.location.href = 'http://internalassistant-e6acf6beh9acc8en.southeastasia-01.azurewebsites.net';
                        }}
                    </script>
                </body>
            </html>
                ...
                <body>
                    <script>
                        if (window.opener) {
                            ...
                            window.location.href = 'http://internalassistant-e6acf6beh9acc8en.southeastasia-01.azurewebsites.net?authenticated=true';
                        }
                    </script>
                </body>
            </html>
...
def get_current_user(request: Request):
    ...
    try:
        ...
        # ONLY use cookie session - no fallback to prevent session mixing
